...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO users(first_name,last_name,birth_date,countries,asylum_number) VALUES('" . $first_name . "','" . $last_name . "','" . ($month)-($day)-($year) . "','" . $countries . "','" . $asylum_number . "')")) {
